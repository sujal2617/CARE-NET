...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">CareNet</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
					    ...
					    <a class="nav-link py-3 px-0 px-lg-3 rounded" href="http://localhost:8091" target="_blank">
					        Track Location
					    </a>
					</li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To CareNet</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Java Development - Spring Boot - Hibernate - JavaScript - React - RESTful API</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		<section class="page-section portfolio" id="portfolio">
		    <div class="container">
		        ...
		        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Donate</h2>
		        <!-- Icon Divider-->
    ...
    <h3 class="text-center">Household</h3> <!-- Added heading -->
    <a href="Household.jsp">
        <div class="portfolio-item mx-auto">
            ...
            <img class="img-fluid" src="assets/img/portfolio/cabin.png" alt="Household" />
        </div>
    </a>
</div>
		            ...
		            <h3 class="text-center">Food</h3> 
		                <a href="Food.jsp">
		                    <div class="portfolio-item mx-auto">
		                        ...
		                        <img class="img-fluid" src="assets/img/portfolio/cake.png" alt="Food" />
		                    </div>
		                </a>
		            </div>
		            <!-- Portfolio Item 3-->
		            ...
		            <h3 class="text-center">Medicine</h3> 
		                <a href="Medicine.jsp">
		                    <div class="portfolio-item mx-auto">
		                        ...
		                        <img class="img-fluid" src="assets/img/portfolio/bg4.png" alt="Medical" />
		                    </div>
		                </a>
		            </div>
		            <!-- Portfolio Item 4-->
		            ...
		            <h3 class="text-center">Electronics</h3> 
		                <a href="Electronics.jsp">
		                    <div class="portfolio-item mx-auto">
		                        ...
		                        <img class="img-fluid" src="assets/img/portfolio/game.png" alt="Electronic" />
		                    </div>
		                </a>
		            </div>
		            <!-- Portfolio Item 5-->
		            ...
		            <h3 class="text-center">Money</h3> 
		                <a href="Money.jsp">
		                    <div class="portfolio-item mx-auto">
		                        ...
		                        <img class="img-fluid" src="assets/img/portfolio/safe.png" alt="Money" />
		                    </div>
		                </a>
		            </div>
		            <!-- Portfolio Item 6-->
		            ...
		            <h3 class="text-center">Transport</h3> 
		                <a href="Transport.jsp">
		                    <div class="portfolio-item mx-auto">
		                        ...
		                        <img class="img-fluid" src="assets/img/portfolio/submarine.png" alt="Transport" />
		                    </div>
		                </a>
		            </div>
		        </div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">CareNet is a platform designed to make the process of giving easier, transparent, and more impactful. By connecting donors with accredited non-profit organizations, CareNet ensures that every donation, whether it's food, 
					</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">clothing, or essentials, reaches the people who need it most efficiently and securely. Our platform promotes trust, community involvement, and meaningful contributions to improve lives during both emergencies and ongoing needs</p>
				</div>
			</div>
