...
<head>
    <meta charset="UTF-8">
    <title>Electronic Items Donation</title>
...
<div class="form-container">
    ...
    <form action="ElectronicsServlet" method="post">
        ...
        <select id="condition" name="itom_condition" required>
...
<script>
    ...
    if (status === "donationSuccess") {
        swal("Thank you!", "Your electronics donation has been successfully recorded.", "success");
